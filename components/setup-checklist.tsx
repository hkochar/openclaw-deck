...
const ITEMS: SetupItem[] = [
  ...
  {
    id: "discord",
    label: "Connect Discord alerts",
    description: "Get budget alerts, drift detection, and pause/resume controls on your phone.",
    link: "/deck-config#edit.channels",
    linkLabel: "Set up Discord",
    required: false,
...
export function SetupChecklist() {
  ...
  const fetchStatus = useCallback(() => {
    Promise.all([
      ...
      const hasDiscord = Object.values(channels).some((v) => v && String(v).length > 10);
