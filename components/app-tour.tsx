...
const STEPS: TourStep[] = [
  ...
  // -- Schedule page --
  {
    ...
    body: "Cron jobs, model configuration, and drift detection. If your provider silently routes to a different model, Deck flags it here and sends an alert.",
  },
  // -- Logs page --
  {
    target: null,
  ...
  // -- Deck Config page --
  {
    ...
    page: "/deck-config",
    title: "Deck Config",
    body: "Set budgets, configure agents, connect Discord or Slack for mobile alerts (pause, resume, restart from your phone), and tune sentinel thresholds.",
  },
  // -- Finish --
  {
    target: null,
